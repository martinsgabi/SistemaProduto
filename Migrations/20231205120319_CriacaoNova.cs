        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantidadeEstoque = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaidaProduto_TipoSaida_TipoSaidaId",
                        column: x => x.TipoSaidaId,
                        principalTable: "TipoSaida",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaidaProduto_Usuario_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaidaProduto_TipoSaidaId",
                table: "SaidaProduto",
                column: "TipoSaidaId");

            migrationBuilder.CreateIndex(
                name: "IX_SaidaProduto_UsuarioId",
                table: "SaidaProduto",
                column: "UsuarioId");
        }
