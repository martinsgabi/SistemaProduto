...
namespace SistemaProduto.Controllers
{
    public class EntradaProdutoController : Controller
    {
        ...
        {
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "Id", "ProdutoName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,QuantidadeEntrada,DataEntrada")] EntradaProduto entradaProduto)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "Id", "ProdutoName", entradaProduto.ProdutoId);
            return View(entradaProduto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoId,QuantidadeEntrada,DataEntrada")] EntradaProduto entradaProduto)
        {
