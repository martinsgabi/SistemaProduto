...
namespace SistemaProduto.Controllers
{
    public class PaisController : Controller
    {
        ...
        public PaisController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pais != null ? 
                          ...
                          Problem("Entity set 'Contexto.Pais'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,PaisNome")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PaisNome")] Pais pais)
        {
            if (id != pais.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Contexto.Pais'  is null.");
            }
            var pais = await _context.Pais.FindAsync(id);
            if (pais != null)
            {
