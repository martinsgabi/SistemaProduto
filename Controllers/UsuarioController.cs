...
namespace SistemaProduto.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UsuarioName,UsuarioEmail,UsuarioSenha")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UsuarioName,UsuarioEmail,UsuarioSenha")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
